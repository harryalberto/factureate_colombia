...
$rowcount = $vobj_mae->get_solicitudes_vinculacion('COUNT', 0, 0, $varr_filtros, $v_order);
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
?>

<BODY bottommargin=0 leftmargin=0 topmargin=0>
<?
    $menu = 'fiduciaria/solicitudes_vinculacion.php';
...
?>
    ...
    <div style="overflow:hidden;text-align:center;font-size: 18px;font-weight: bold;color:#064677;padding:10px;width:500px;margin:auto;">
        Relaci&oacute;n de Solicitudes de Vinculaci&oacute;n
    </div>
            ...
            <table class="tabla_resize">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="sort asc">TIPO REG</th>   <th scope="col" class="sort asc">FECHA SOL</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-header">
            <ul style="list-style:none;overflow:hidden;">
                <li style="display:block;width:200px;float:left;"><h5 class="modal-title fs-5" id="exampleModalLabel" style="color:#064677;font-weight: bold;">Detalle de la Solicitud</h5></li>
    ...
    <script type="text/javascript">
        ...
        function getData() {
            ...
            fetch("load_solicitudes_vinculacion.php", {
                    method: "POST",
                    body: formaData
                })
    ...
    <script type="text/javascript">
        function verDetalle(p_inversor_id, p_tinversor_id){
            if (p_tinversor_id == 85){
            //persona natural
                $('.modal-title').text('DETALLE SOLICITUD');
                $('.modal-body').load('solicitud_vinculacion_modal.php?inversor_id='+p_inversor_id,function(){
        ...
        function refresh_page(){
            location.href = "solicitudes_vinculacion.php";
        }
    </script>
