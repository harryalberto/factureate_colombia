...
<?
    $menu = 'fiduciaria/liquidaciones.php';
    //------ PARTE SUPERIOR ------
...
?>
    ...
    <div style="overflow:hidden;margin:5px;padding:5px;">
        <nav style="font-size:12px;">
            <label style="margin-right:5px;">Fecha de Liquidacion desde el: </label>
            <input type="date" class="formulario_control" id="fini" name="fini" value="<?=$v_fini?>" style="margin-right:10px;">
            <label style="margin-right:5px;">hasta: </label>
            <input type="date" class="formulario_control" id="ffin" name="ffin" value="<?=$v_fhoy?>">
            <button type="button" class="btn btn-primary" style="font-size:10px;background-color:var(--color-azulv2);border:none;" onclick="filtrarLiquidaciones()"><i class="fa-solid fa-filter"></i></button>
        </nav>
        <div style="overflow:hidden;margin:5px;padding:5px;">
            <table class="tabla_resize">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="sort asc">VENDEDOR</th>            <th scope="col" class="sort asc">PAGADOR</th>
                        <th scope="col" class="sort asc">F FINAN</th>             <th scope="col" class="sort asc">F VENCIMIENTO</th>
                        <th scope="col" class="sort asc">F PAGO</th>              <th scope="col" class="sort asc">DIAS FINAN</th>
                        <th scope="col" class="sort asc">DIAS RETRASO</th>         
                        <th scope="col" class="sort asc"><abbr title="Tasa de interes anual que gana el inversor, si es mas de un inversor es la tasa compuesta">TASA %</abbr></th>
                        <th scope="col" class="sort asc">MONEDA</th>              <th scope="col" class="sort asc">MONTO FACTURA</th>
                        <th scope="col" class="sort asc">MONTO FINAN</th>         <th scope="col" class="sort asc">GANANCIA INVERSOR</th>
                        <th scope="col" class="sort asc">COMISION FACTUREATE</th> <th scope="col" class="sort asc">REMANENTE</th>
                    </tr>
                </thead>
                <tbody id="content">
