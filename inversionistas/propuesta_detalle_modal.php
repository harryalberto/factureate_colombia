...
?>
    ...
    ?>
        ...
        <div style="overflow:hidden;background-color:#555555;height:1px;"></div>
        <ul style="margin-top:10px;">
            <li style="font-weight:bold;">PROPUESTA: <?php echo $v_alerta_preliminar;?></li>
        </ul>
    <?php
    $varr_parametros = $obj_mae->get_parametros();
    ...
    if ($varr_parametros['CROWD']['valornum'] == 0){        // NO SE ADMITE EL CROWD OSEA SE COMPRA EL 100%
        echo '
        <ul>
            <li style="font-weight:bold;">MONTO A INVERTIR ('.$arrsubasta['moneda'].'):</li>
            <li><input type="text" class="frminput_text_off" name="monto_label" value="'.number_format($monto,2,'.',',').'" style="width:100px;text-align:right;" readonly></li>
            <input type="hidden" name="monto" id="monto" value="'.$monto.'">
            <li style="font-weight:bold;">% DE LA FACTURA:</li>
            <li><input type="text" class="frminput_text_off" name="porcmonto" id="porcmonto" value="'.$porcmonto.'" style="width:100px;text-align:right;" readonly></li>
        </ul>
        <ul>
            <li style="font-weight:bold;"><abbr title="Tasa de Interes Efectiva Anual que desea ganar por su inversión">TEA (%):</abbr></li>
            <li><input type="number" class="frminput_text" name="tia" id="tia" value="'.$tia.'" min="5" max="40" style="width:100px;text-align:right;" onchange=javascript:validapropuesta("tia")></li>
            <li style="font-weight:bold;">GANANCIA ESTIMADA ('.$arrsubasta['moneda'].'):</li>
        ...
        <ul>
            ...
            <li style="font-weight:bold;">% DE LA FACTURA:</li>
            <li>
                <select name="porcmonto" id="porcmonto" onchange="cambia_porciento()">';

        if ($porcmonto == 10) echo '
                    <option value="10" selected>10 %</option>'; else echo '
                    <option value="10">10 %</option>';
        if ($porcmonto == 20) echo '
                    <option value="20" selected>20 %</option>'; else echo '
                    <option value="20">20 %</option>';
        if ($porcmonto == 30) echo '
                    <option value="30" selected>30 %</option>'; else echo '
                    <option value="30">30 %</option>';
        if ($porcmonto == 40) echo '
                    <option value="40" selected>40 %</option>'; else echo '
                    <option value="40">40 %</option>';
        if ($porcmonto == 50) echo '
                    <option value="50" selected>50 %</option>'; else echo '
                    <option value="50">50 %</option>';
        if ($porcmonto == 60) echo '
                    <option value="60" selected>60 %</option>'; else echo '
                    <option value="60">60 %</option>';
        if ($porcmonto == 70) echo '
                    <option value="70" selected>70 %</option>'; else echo '
                    <option value="70">70 %</option>';
        if ($porcmonto == 80) echo '
                    <option value="80" selected>80 %</option>'; else echo '
                    <option value="80">80 %</option>';
        if ($porcmonto == 90) echo '
                    <option value="90" selected>90 %</option>'; else echo '
                    <option value="90">90 %</option>';
        if ($porcmonto == 100) echo '
                    <option value="100" selected>100 %</option>'; else echo '
        ...
        <ul>
            <li style="font-weight:bold;"><abbr title="Tasa de Interes Anual que desea ganar por su inversión">TEA (%):</abbr></li>
            <li><input type="number" class="frminput_text" name="tia" id="tia" value="'.$tia.'" min="5" max="40" style="width:100px;text-align:right;" onchange=javascript:validapropuesta("tia")></li>
            <li style="font-weight:bold;">GANANCIA ESTIMADA ('.$arrsubasta['moneda'].'):</li>
            <li><input type="text" class="frminput_text_off" name="ganancia" value="'.number_format($ganancia,2,'.',',').'" style="width:100px;text-align:right;" readonly></li>
        </ul>';
    ...
    <script>
        ...
        function cambia_porciento(){
            ...
            document.frm_modal.monto_label.value = monto_invertir.toFixed(2);
        }
    </script>
</BODY>
</HTML>