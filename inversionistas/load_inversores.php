...
if ($_POST['orderCol'] == 8) $v_order = 'inversionista.contrato_enviado '.$_POST['orderType'];
...
for ($i = 0; $i < count($varr_inversores); $i++){
    ...
    $output['data'] .= '<tr>
                            ...
                            <td data-label="CONTRATO ENVIO">'.$v_contrato_enviado.'</td>
                            <td data-label="DETALLE">'.$v_boton_detalle.'</td>                          <td data-label="BLOQUEO">'.$v_boton_bloqueo.'</td>
                        </tr>';
}
