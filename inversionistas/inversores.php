...
//==== CALCULO LOS FILTROS
$filtros = 'inversionista.estado in ('.$v_estados.')';
...
<?
    $menu = 'inversionistas/inversores.php';
...
?>
            <li><button type="button" class="btn btn-primary" style="font-size:11px;background-color:var(--color-azulv2);border:none;margin-right: 10px;" onclick="filtrar()"><i class="fa-solid fa-filter"></i> Filtrar</button>
                <button type="button" class="btn btn-primary" style="font-size:11px;background-color:var(--color-azulv2);border:none;margin-right: 10px;" onclick="nuevoInversor()"><i class="fa-solid fa-person-circle-plus"></i> Nuevo Inversor Persona</button>
                <button type="button" class="btn btn-primary" style="font-size:11px;background-color:var(--color-azulv2);border:none;margin-right: 10px;" onclick="nuevoInversorEmp()"><i class="fa-regular fa-building"></i> Nuevo Inversor Empresa</button>
            </li>
        </ul>
        </form>
    </div>
            ...
            <table class="tabla_resize">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="sort asc">TIPO</th>       <th scope="col" class="sort asc">CATEGORIA</th>    <th scope="col" class="sort asc">CONTRATO ENVIO</th>
                        <th scope="col" class="sort asc">DETALLE</th>    <th scope="col" class="sort asc">BLOQUEO</th>
                    </tr>
                </thead>
                <tbody id="content">
