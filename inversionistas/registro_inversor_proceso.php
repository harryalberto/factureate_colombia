...
if ($_POST['que_guardo'] == 'datos_personales'){
    $varr_datos = array('inversionista_id'=>$_POST['inversor_id'],  'telefono_persona' => $_POST['telefono'],   'email_persona' => $_POST['email'],
                        ...
                        'condicion_laboral' => $_POST['cond_laboral'], 'inversor_id' => $_POST['user_id'],      'direccion' => $_POST['direccion']);
    
    //@@@@ CARPETA DE VINCULACION
    $v_apellidos = ltrim(rtrim($_POST['apellido']));
    $varr_apellidos = explode(" ", $v_apellidos);
    $v_carpeta = '../archivos/INV_'.$_POST['nombre'].'_'.$varr_apellidos[0].'_'.$varr_apellidos[1].'_'.$_POST['nrodoc'].'/vinculacion';
    ...
    $varr_apellidos = explode(" ", $v_apellidos);
    $v_carpeta = '../archivos/INV_'.$varr_inversor_proc['inversor_nombre'].'_'.$varr_apellidos[0].'_'.$varr_apellidos[1].'_'.$varr_inversor_proc['identificacion'].'/cuentas';
    ...
    $varr_datos_cuenta = array('inversor_id' => $_POST['inversor_id'], 'banco_id' => $_POST['banco'], 'tcuenta_id' => $_POST['t_cuenta'], 'cuenta' => $_POST['cuenta'],
                        'moneda_id' => $_POST['moneda'], 'empresa_id' => $_POST['empresa_id'], 'certificado_path' => $v_file_certificado);
