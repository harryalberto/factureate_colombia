...
if ($_POST['rowcount'] == 0) $rowcount = $vobj_mae_load->get_empresas_riesgo_pend(0, 0,'count');
...
*/
$varr_empresas = $vobj_mae_load->get_empresas_riesgo_pend($_POST['registros'],$rowini,'select');
