...
$rowcount = $objmaestro->get_empresas_riesgo_pend(0, 0,'count');
/*--------------------------------------------------------*/
?>
...
?>
    ...
    <div style="overflow:hidden;text-align:center;font-size: 18px;font-weight: bold;color:#064677;padding:10px;width:500px;margin:auto;">
        Empresas Pagadoras con Evaluación de Riesgo Pendiente
    </div>
    ...
    <script type="text/javascript">
        ...
        function getData() {
            ...
            fetch("empresas_riesgo_pend_load.php", {
                    method: "POST",
                    body: formaData
                })
    ...
    <script type="text/javascript">
        ...
        function refresh_page(){
            location.href = "empresas_riesgo_pend.php";
        }
    </script>
</BODY>
</HTML>