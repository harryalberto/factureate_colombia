...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  $v_resultado = $obj_mae->registra_interes_contacto($input);
  $output = array('resultado' => 1, 'mensaje' => $v_resultado);

  //--- envio de correo al equipo Factureate
  if ($input['t_interes'] == 116) $v_interes = 'INVERSION';
  else $v_interes = 'SOLICITUD DE FINANCIAMIENTO';

  $varr_mail = array('notificaid' => 43, 'datos_body' => 'Nombre: '.$input['nombre'].'<br>Interes: '.$v_interes.'<br><br>Factureate');
