...
<?
    $menu = 'maestros/crear_usuarios.php';
...
?>
    ...
    <div style="overflow:hidden;text-align:center;font-size: 18px;font-weight: bold;color:#064677;padding:10px;width:500px;margin:auto;">
        Relaci&oacute;n de Usuarios
    </div>

    <!--@@@@ BOTONES Y FILTROS -->
    <nav>
        <button type="button" class="btn btn-primary" style="font-size:11px;background-color:var(--color-azulv2);border:none;" onclick="nuevoUsuario()">Nuevo Usuario</button>
    </nav>
    <!--==== TABLA HEADER -->
            ...
            <table class="tabla_resize">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="sort asc">TELEFONO</th>   <th scope="col" class="sort asc">TIPO USUARIO</th>
                        <th scope="col" class="sort asc">PERFIL</th>     <th scope="col" class="sort asc">FIDUCIA</th>
                        <th scope="col" class="sort asc">EMPRESA</th>    <th scope="col" class="sort asc">DETALLE</th>
                    </tr>
                </thead>
                <tbody id="content">
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-header">
            <ul style="list-style:none;overflow:hidden;">
                <li style="display:block;width:200px;float:left;"><h5 class="modal-title fs-5" id="exampleModalLabel" style="color:#064677;font-weight: bold;">Detalle de Usuario</h5></li>
    ...
    <script type="text/javascript">
        function nuevoUsuario(){
            ...
            $('.modal-body').load('crear_usuarios_modal.php?usuario_id=0',function(){
                $('#InversorDetalle').modal({show:true});
            });
        }

        function verDetalle(p_usuario_id){
            $('.modal-title').text('DETALLE USUARIO');
            $('.modal-body').load('crear_usuarios_modal.php?usuario_id='+p_usuario_id,function(){
                $('#InversorDetalle').modal({show:true});
            });
        }

        function refresh_page(){
            location.href = "crear_usuarios.php";
        }
    </script>
